...
public class MapViewer extends Canvas {
     ...
     * <p/>
     * The scale represents the length of one GameTile in pixels. This value
     * must be positive.
     * <p/>
     ...
     * <p/>
     * A WorldMap should be set using the
     * <code>useMap(WorldMap)</code> method before calling this method.
     *
     * @return itself for fluency
     */
     ...
     * <p/>
     * When this method is called once, consecutive calls of this method do
     * nothing. Also, paint method calls are ignored.
     * <p/>
     ...
     * repaint is done.
     * <p/>
     * Windows that contain this Canvas should call this method when they are
     * disposed to ensure the Renderer is stopped gracefully.
     */
    ...
    public void paint(Graphics g) {
        ...
        for (int x = r.x; x < r.x + r.width; x++) {
            for (int y = r.y; y < r.y + r.height; y++) {
                ...
                if (tile == null) {
                    c = getColor(EMPTY);
                } else if (tile.getCollisionFlag() == GameTile.BLOCK
                        && tile.getBoundary() == -1) {
                    c = getColor(WATER);
                } else {
