...
#define JACE_PROXY_JAVA_LANG_AUTOCLOSEABLE_H
...
/**
 * The Jace C++ proxy class for java/lang/AutoCloseable.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class AutoCloseable : public virtual ::jace::proxy::java::lang::Object {
 ...
 */
AutoCloseable();
AutoCloseable( jvalue value );
AutoCloseable( jobject object );
AutoCloseable( const AutoCloseable& object );
AutoCloseable( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< AutoCloseable> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::AutoCloseable>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::AutoCloseable>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::AutoCloseable>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::AutoCloseable>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::AutoCloseable>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::AutoCloseable>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::AutoCloseable>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_AUTOCLOSEABLE_H
