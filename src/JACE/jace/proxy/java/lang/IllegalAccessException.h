...
#define JACE_PROXY_JAVA_LANG_ILLEGALACCESSEXCEPTION_H
...
/**
 * The Jace C++ proxy class for java/lang/IllegalAccessException.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class IllegalAccessException : public ::jace::proxy::java::lang::ReflectiveOperationException {
 ...
 *
 */
IllegalAccessException( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
IllegalAccessException( jvalue value );
IllegalAccessException( jobject object );
IllegalAccessException( const IllegalAccessException& object );
IllegalAccessException( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< IllegalAccessException> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::IllegalAccessException>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::IllegalAccessException>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::IllegalAccessException>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::IllegalAccessException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::IllegalAccessException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::IllegalAccessException>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::IllegalAccessException>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_ILLEGALACCESSEXCEPTION_H
