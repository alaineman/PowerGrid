...
#define JACE_PROXY_JAVA_LANG_INTERRUPTEDEXCEPTION_H
...
/**
 * The Jace C++ proxy class for java/lang/InterruptedException.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class InterruptedException : public ::jace::proxy::java::lang::Exception {
 ...
 *
 */
InterruptedException( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
InterruptedException( jvalue value );
InterruptedException( jobject object );
InterruptedException( const InterruptedException& object );
InterruptedException( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< InterruptedException> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::InterruptedException>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::InterruptedException>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::InterruptedException>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::InterruptedException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::InterruptedException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::InterruptedException>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::InterruptedException>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_INTERRUPTEDEXCEPTION_H
