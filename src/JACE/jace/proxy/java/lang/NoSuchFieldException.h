...
#define JACE_PROXY_JAVA_LANG_NOSUCHFIELDEXCEPTION_H
...
/**
 * The Jace C++ proxy class for java/lang/NoSuchFieldException.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class NoSuchFieldException : public ::jace::proxy::java::lang::ReflectiveOperationException {
 ...
 *
 */
NoSuchFieldException( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
NoSuchFieldException( jvalue value );
NoSuchFieldException( jobject object );
NoSuchFieldException( const NoSuchFieldException& object );
NoSuchFieldException( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< NoSuchFieldException> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::NoSuchFieldException>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::NoSuchFieldException>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::NoSuchFieldException>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::NoSuchFieldException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::NoSuchFieldException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::NoSuchFieldException>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::NoSuchFieldException>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_NOSUCHFIELDEXCEPTION_H
