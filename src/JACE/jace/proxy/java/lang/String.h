 ...
 *
 */
String( ::jace::JArray< ::jace::proxy::types::JByte > p0, ::jace::proxy::types::JInt p1, ::jace::proxy::types::JInt p2, ::jace::proxy::java::nio::charset::Charset p3 );
 ...
 *
 */
String( ::jace::JArray< ::jace::proxy::types::JByte > p0, ::jace::proxy::java::nio::charset::Charset p1 );
 ...
 *
 */
String( ::jace::proxy::java::lang::StringBuffer p0 );

/**
 * String
 *
 */
String( ::jace::proxy::java::lang::StringBuilder p0 );
 ...
 *
 */
::jace::JArray< ::jace::proxy::types::JByte > getBytes( ::jace::proxy::java::nio::charset::Charset p0 );
 ...
 *
 */
::jace::proxy::types::JBoolean contentEquals( ::jace::proxy::java::lang::StringBuffer p0 );
 ...
 *
 */
::jace::proxy::java::lang::String toLowerCase( ::jace::proxy::java::util::Locale p0 );
 ...
 *
 */
::jace::proxy::java::lang::String toUpperCase( ::jace::proxy::java::util::Locale p0 );
 ...
 *
 */
static ::jace::proxy::java::lang::String format( ::jace::proxy::java::util::Locale p0, ::jace::proxy::java::lang::String p1, ::jace::JArray< ::jace::proxy::java::lang::Object > p2 );
...
/** Above functionality provided as named member function. */
std::string toStdString() { return getCString(); }
