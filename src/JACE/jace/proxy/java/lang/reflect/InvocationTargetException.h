...
#define JACE_PROXY_JAVA_LANG_REFLECT_INVOCATIONTARGETEXCEPTION_H
...
/**
 * The Jace C++ proxy class for java/lang/reflect/InvocationTargetException.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class InvocationTargetException : public ::jace::proxy::java::lang::ReflectiveOperationException {
 ...
 *
 */
InvocationTargetException( ::jace::proxy::java::lang::Throwable p0 );

/**
 * InvocationTargetException
 *
 */
InvocationTargetException( ::jace::proxy::java::lang::Throwable p0, ::jace::proxy::java::lang::String p1 );

/**
 * getTargetException
 *
 */
::jace::proxy::java::lang::Throwable getTargetException();
 ...
 *
 */
InvocationTargetException( jvalue value );
InvocationTargetException( jobject object );
InvocationTargetException( const InvocationTargetException& object );
InvocationTargetException( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< InvocationTargetException> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::reflect::InvocationTargetException>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::reflect::InvocationTargetException>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::reflect::InvocationTargetException>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::reflect::InvocationTargetException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::reflect::InvocationTargetException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::reflect::InvocationTargetException>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::reflect::InvocationTargetException>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_REFLECT_INVOCATIONTARGETEXCEPTION_H
