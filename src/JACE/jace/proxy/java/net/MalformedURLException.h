...
#define JACE_PROXY_JAVA_NET_MALFORMEDURLEXCEPTION_H
...
/**
 * The Jace C++ proxy class for java/net/MalformedURLException.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class MalformedURLException : public ::jace::proxy::java::io::IOException {
 ...
 *
 */
MalformedURLException( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
MalformedURLException( jvalue value );
MalformedURLException( jobject object );
MalformedURLException( const MalformedURLException& object );
MalformedURLException( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< MalformedURLException> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::net::MalformedURLException>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::net::MalformedURLException>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::net::MalformedURLException>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::net::MalformedURLException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::net::MalformedURLException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::net::MalformedURLException>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::net::MalformedURLException>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NET_MALFORMEDURLEXCEPTION_H
