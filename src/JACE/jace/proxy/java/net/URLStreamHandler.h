...
#define JACE_PROXY_JAVA_NET_URLSTREAMHANDLER_H
...
/**
 * The Jace C++ proxy class for java/net/URLStreamHandler.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class URLStreamHandler : public virtual ::jace::proxy::java::lang::Object {
 ...
 *
 */
URLStreamHandler( jvalue value );
URLStreamHandler( jobject object );
URLStreamHandler( const URLStreamHandler& object );
URLStreamHandler( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< URLStreamHandler> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::net::URLStreamHandler>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::net::URLStreamHandler>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::net::URLStreamHandler>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::net::URLStreamHandler>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::net::URLStreamHandler>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::net::URLStreamHandler>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::net::URLStreamHandler>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NET_URLSTREAMHANDLER_H
