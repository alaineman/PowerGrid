...
#define JACE_PROXY_JAVA_NIO_FILE_OPENOPTION_H
...
/**
 * The Jace C++ proxy class for java/nio/file/OpenOption.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class OpenOption : public virtual ::jace::proxy::java::lang::Object {
 ...
 */
OpenOption();
OpenOption( jvalue value );
OpenOption( jobject object );
OpenOption( const OpenOption& object );
OpenOption( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< OpenOption> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::OpenOption>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::OpenOption>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::OpenOption>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::OpenOption>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::OpenOption>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::OpenOption>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::OpenOption>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_OPENOPTION_H
