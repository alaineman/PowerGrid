...
#define JACE_PROXY_JAVA_NIO_FILE_ATTRIBUTE_FILESTOREATTRIBUTEVIEW_H
...
/**
 * The Jace C++ proxy class for java/nio/file/attribute/FileStoreAttributeView.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class FileStoreAttributeView : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::nio::file::attribute::AttributeView {
...
FileStoreAttributeView( jvalue value );
FileStoreAttributeView( jobject object );
FileStoreAttributeView( const FileStoreAttributeView& object );
FileStoreAttributeView( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< FileStoreAttributeView> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::attribute::FileStoreAttributeView>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::attribute::FileStoreAttributeView>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::attribute::FileStoreAttributeView>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileStoreAttributeView>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileStoreAttributeView>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileStoreAttributeView>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileStoreAttributeView>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_ATTRIBUTE_FILESTOREATTRIBUTEVIEW_H
