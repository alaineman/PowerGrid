...
#define JACE_PROXY_JAVA_SECURITY_GUARD_H
...
/**
 * The Jace C++ proxy class for java/security/Guard.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Guard : public virtual ::jace::proxy::java::lang::Object {
...
Guard();
Guard( jvalue value );
Guard( jobject object );
Guard( const Guard& object );
Guard( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< Guard> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::security::Guard>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::security::Guard>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::security::Guard>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::security::Guard>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::security::Guard>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::security::Guard>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::security::Guard>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_SECURITY_GUARD_H
