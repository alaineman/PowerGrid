...
#define JACE_PROXY_JAVA_SECURITY_KEYEXCEPTION_H
...
/**
 * The Jace C++ proxy class for java/security/KeyException.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class KeyException : public ::jace::proxy::java::security::GeneralSecurityException {
 ...
 *
 */
KeyException( ::jace::proxy::java::lang::String p0 );

/**
 * KeyException
 *
 */
KeyException( ::jace::proxy::java::lang::String p0, ::jace::proxy::java::lang::Throwable p1 );

/**
 * KeyException
 *
 */
KeyException( ::jace::proxy::java::lang::Throwable p0 );
 ...
 *
 */
KeyException( jvalue value );
KeyException( jobject object );
KeyException( const KeyException& object );
KeyException( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< KeyException> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::security::KeyException>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::security::KeyException>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::security::KeyException>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::security::KeyException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::security::KeyException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::security::KeyException>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::security::KeyException>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_SECURITY_KEYEXCEPTION_H
