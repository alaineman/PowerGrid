...
#define JACE_PROXY_JAVA_SECURITY_PERMISSIONCOLLECTION_H
...
/**
 * The Jace C++ proxy class for java/security/PermissionCollection.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class PermissionCollection : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::io::Serializable {
 ...
 *
 */
void add( ::jace::proxy::java::security::Permission p0 );
 ...
 *
 */
PermissionCollection( jvalue value );
PermissionCollection( jobject object );
PermissionCollection( const PermissionCollection& object );
PermissionCollection( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< PermissionCollection> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::security::PermissionCollection>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::security::PermissionCollection>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::security::PermissionCollection>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::security::PermissionCollection>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::security::PermissionCollection>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::security::PermissionCollection>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::security::PermissionCollection>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_SECURITY_PERMISSIONCOLLECTION_H
