...
#define JACE_PROXY_JAVA_SECURITY_TIMESTAMP_H
...
/**
 * The Jace C++ proxy class for java/security/Timestamp.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Timestamp : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::io::Serializable {
 ...
 *
 */
Timestamp( ::jace::proxy::java::util::Date p0, ::jace::proxy::java::security::cert::CertPath p1 );

/**
 * getTimestamp
 *
 */
::jace::proxy::java::util::Date getTimestamp();
 ...
 *
 */
Timestamp( jvalue value );
Timestamp( jobject object );
Timestamp( const Timestamp& object );
Timestamp( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< Timestamp> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::security::Timestamp>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::security::Timestamp>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::security::Timestamp>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::security::Timestamp>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::security::Timestamp>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::security::Timestamp>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::security::Timestamp>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_SECURITY_TIMESTAMP_H
