...
#define JACE_PROXY_JAVA_UTIL_CONCURRENT_CALLABLE_H
...
/**
 * The Jace C++ proxy class for java/util/concurrent/Callable.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Callable : public virtual ::jace::proxy::java::lang::Object {
 ...
 *
 */
::jace::proxy::java::lang::Object call();
 ...
 */
Callable();
Callable( jvalue value );
Callable( jobject object );
Callable( const Callable& object );
Callable( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< Callable> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::util::concurrent::Callable>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::util::concurrent::Callable>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::util::concurrent::Callable>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::util::concurrent::Callable>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::util::concurrent::Callable>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::util::concurrent::Callable>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::util::concurrent::Callable>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_UTIL_CONCURRENT_CALLABLE_H
