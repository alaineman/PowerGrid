...
#define JACE_PROXY_JAVA_UTIL_CONCURRENT_TIMEOUTEXCEPTION_H
...
/**
 * The Jace C++ proxy class for java/util/concurrent/TimeoutException.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class TimeoutException : public ::jace::proxy::java::lang::Exception {
 ...
 *
 */
TimeoutException( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
TimeoutException( jvalue value );
TimeoutException( jobject object );
TimeoutException( const TimeoutException& object );
TimeoutException( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< TimeoutException> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::util::concurrent::TimeoutException>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::util::concurrent::TimeoutException>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::util::concurrent::TimeoutException>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::util::concurrent::TimeoutException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::util::concurrent::TimeoutException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::util::concurrent::TimeoutException>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::util::concurrent::TimeoutException>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_UTIL_CONCURRENT_TIMEOUTEXCEPTION_H
