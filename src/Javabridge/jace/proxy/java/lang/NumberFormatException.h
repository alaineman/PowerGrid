...
#define JACE_PROXY_JAVA_LANG_NUMBERFORMATEXCEPTION_H
...
/**
 * The Jace C++ proxy class for java/lang/NumberFormatException.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class NumberFormatException : public ::jace::proxy::java::lang::IllegalArgumentException {
 ...
 *
 */
NumberFormatException( ::jace::proxy::java::lang::String p0 );
 ...
 *
 */
NumberFormatException( jvalue value );
NumberFormatException( jobject object );
NumberFormatException( const NumberFormatException& object );
NumberFormatException( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< NumberFormatException> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::NumberFormatException>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::NumberFormatException>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::NumberFormatException>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::NumberFormatException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::NumberFormatException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::NumberFormatException>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::NumberFormatException>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_NUMBERFORMATEXCEPTION_H
