 ...
 *
 */
Thread( ::jace::proxy::java::lang::ThreadGroup p0, ::jace::proxy::java::lang::Runnable p1 );
 ...
 *
 */
Thread( ::jace::proxy::java::lang::ThreadGroup p0, ::jace::proxy::java::lang::String p1 );
 ...
 *
 */
Thread( ::jace::proxy::java::lang::ThreadGroup p0, ::jace::proxy::java::lang::Runnable p1, ::jace::proxy::java::lang::String p2 );

/**
 * Thread
 *
 */
Thread( ::jace::proxy::java::lang::ThreadGroup p0, ::jace::proxy::java::lang::Runnable p1, ::jace::proxy::java::lang::String p2, ::jace::proxy::types::JLong p3 );
 ...
 *
 */
::jace::proxy::java::lang::ClassLoader getContextClassLoader();

/**
 * setContextClassLoader
 *
 */
void setContextClassLoader( ::jace::proxy::java::lang::ClassLoader p0 );
 ...
 *
 */
::jace::JArray< ::jace::proxy::java::lang::StackTraceElement > getStackTrace();
 ...
 *
 */
::jace::proxy::java::lang::Thread_State getState();

/**
 * setDefaultUncaughtExceptionHandler
 *
 */
static void setDefaultUncaughtExceptionHandler( ::jace::proxy::java::lang::Thread_UncaughtExceptionHandler p0 );

/**
 * getDefaultUncaughtExceptionHandler
 *
 */
static ::jace::proxy::java::lang::Thread_UncaughtExceptionHandler getDefaultUncaughtExceptionHandler();

/**
 * getUncaughtExceptionHandler
 *
 */
::jace::proxy::java::lang::Thread_UncaughtExceptionHandler getUncaughtExceptionHandler();

/**
 * setUncaughtExceptionHandler
 *
 */
void setUncaughtExceptionHandler( ::jace::proxy::java::lang::Thread_UncaughtExceptionHandler p0 );
...
static JEnlister< Thread> enlister;
};
