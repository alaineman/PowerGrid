 ...
 *
 */
void setStackTrace( ::jace::JArray< ::jace::proxy::java::lang::StackTraceElement > p0 );

/**
 * addSuppressed
 *
 */
void addSuppressed( ::jace::proxy::java::lang::Throwable p0 );

/**
 * getSuppressed
 *
 */
::jace::JArray< ::jace::proxy::java::lang::Throwable > getSuppressed();
