...
#define JACE_PROXY_JAVA_LANG_REFLECT_CONSTRUCTOR_H
...
/**
 * The Jace C++ proxy class for java/lang/reflect/Constructor.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Constructor : public ::jace::proxy::java::lang::reflect::AccessibleObject, public virtual ::jace::proxy::java::lang::reflect::GenericDeclaration, public virtual ::jace::proxy::java::lang::reflect::Member {
 ...
 *
 */
::jace::proxy::java::lang::Object newInstance( ::jace::JArray< ::jace::proxy::java::lang::Object > p0 );
 ...
 *
 */
Constructor( jvalue value );
Constructor( jobject object );
Constructor( const Constructor& object );
Constructor( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< Constructor> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::reflect::Constructor>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::reflect::Constructor>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::reflect::Constructor>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::reflect::Constructor>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::reflect::Constructor>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::reflect::Constructor>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::reflect::Constructor>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_REFLECT_CONSTRUCTOR_H
