...
#define JACE_PROXY_JAVA_LANG_REFLECT_GENERICDECLARATION_H
...
/**
 * The Jace C++ proxy class for java/lang/reflect/GenericDeclaration.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class GenericDeclaration : public virtual ::jace::proxy::java::lang::Object {
 ...
 */
GenericDeclaration();
GenericDeclaration( jvalue value );
GenericDeclaration( jobject object );
GenericDeclaration( const GenericDeclaration& object );
GenericDeclaration( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< GenericDeclaration> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::lang::reflect::GenericDeclaration>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::lang::reflect::GenericDeclaration>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::reflect::GenericDeclaration>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::lang::reflect::GenericDeclaration>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::reflect::GenericDeclaration>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::lang::reflect::GenericDeclaration>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::reflect::GenericDeclaration>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_LANG_REFLECT_GENERICDECLARATION_H
