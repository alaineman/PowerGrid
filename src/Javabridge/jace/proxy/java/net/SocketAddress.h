...
#define JACE_PROXY_JAVA_NET_SOCKETADDRESS_H
...
/**
 * The Jace C++ proxy class for java/net/SocketAddress.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class SocketAddress : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::io::Serializable {
 ...
 *
 */
SocketAddress( jvalue value );
SocketAddress( jobject object );
SocketAddress( const SocketAddress& object );
SocketAddress( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< SocketAddress> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::net::SocketAddress>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::net::SocketAddress>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::net::SocketAddress>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::net::SocketAddress>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::net::SocketAddress>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::net::SocketAddress>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::net::SocketAddress>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NET_SOCKETADDRESS_H
