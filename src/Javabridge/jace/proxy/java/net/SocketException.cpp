...
/**
 * The Jace C++ proxy class source for java/net/SocketException.
 * Please do not edit this source, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
#ifndef VIRTUAL_INHERITANCE_IS_BROKEN
  #define SocketException_INITIALIZER : ::jace::proxy::java::io::IOException( NO_OP ), ::jace::proxy::java::lang::Object( NO_OP )
#else
  #define SocketException_INITIALIZER : ::jace::proxy::java::io::IOException( NO_OP )
#endif

SocketException::SocketException( ::jace::proxy::java::lang::String p0 ) SocketException_INITIALIZER {
...
SocketException::SocketException() SocketException_INITIALIZER {
  ::jace::JArguments arguments;
  jobject localRef = newObject( arguments );
  setJavaJniObject( localRef );
  JNIEnv* env = ::jace::helper::attach();
 ...
 *
 */
SocketException::SocketException( jvalue value ) SocketException_INITIALIZER {
  setJavaJniValue( value );
}

SocketException::SocketException( jobject object ) SocketException_INITIALIZER {
  setJavaJniObject( object );
}

SocketException::SocketException( const SocketException& object ) SocketException_INITIALIZER {
  setJavaJniObject( object.getJavaJniObject() );
}

SocketException::SocketException( const NoOp& noOp ) SocketException_INITIALIZER {
}

const JClass* SocketException::staticGetJavaJniClass() throw ( JNIException ) {
  static JClassImpl javaClass( "java/net/SocketException" );
  return &javaClass;
}

const JClass* SocketException::getJavaJniClass() const throw ( JNIException ) {
  return SocketException::staticGetJavaJniClass();
}

JEnlister< SocketException> SocketException::enlister;
