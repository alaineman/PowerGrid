...
#define JACE_PROXY_JAVA_NIO_CHANNELS_ASYNCHRONOUSCHANNEL_H
...
/**
 * The Jace C++ proxy class for java/nio/channels/AsynchronousChannel.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class AsynchronousChannel : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::nio::channels::Channel {
 ...
 */
AsynchronousChannel();
AsynchronousChannel( jvalue value );
AsynchronousChannel( jobject object );
AsynchronousChannel( const AsynchronousChannel& object );
AsynchronousChannel( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< AsynchronousChannel> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::channels::AsynchronousChannel>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::channels::AsynchronousChannel>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::channels::AsynchronousChannel>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::AsynchronousChannel>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::AsynchronousChannel>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::AsynchronousChannel>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::channels::AsynchronousChannel>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_CHANNELS_ASYNCHRONOUSCHANNEL_H
