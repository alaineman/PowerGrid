...
#define JACE_PROXY_JAVA_NIO_CHANNELS_BYTECHANNEL_H
...
/**
 * The Jace C++ proxy class for java/nio/channels/ByteChannel.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class ByteChannel : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::nio::channels::ReadableByteChannel, public virtual ::jace::proxy::java::nio::channels::WritableByteChannel {
 ...
 */
ByteChannel();
ByteChannel( jvalue value );
ByteChannel( jobject object );
ByteChannel( const ByteChannel& object );
ByteChannel( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< ByteChannel> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::channels::ByteChannel>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::channels::ByteChannel>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::channels::ByteChannel>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::ByteChannel>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::ByteChannel>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::ByteChannel>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::channels::ByteChannel>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_CHANNELS_BYTECHANNEL_H
