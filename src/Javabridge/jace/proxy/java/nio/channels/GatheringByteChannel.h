...
#define JACE_PROXY_JAVA_NIO_CHANNELS_GATHERINGBYTECHANNEL_H
...
/**
 * The Jace C++ proxy class for java/nio/channels/GatheringByteChannel.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class GatheringByteChannel : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::nio::channels::WritableByteChannel {
...
GatheringByteChannel( jvalue value );
GatheringByteChannel( jobject object );
GatheringByteChannel( const GatheringByteChannel& object );
GatheringByteChannel( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< GatheringByteChannel> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::channels::GatheringByteChannel>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::channels::GatheringByteChannel>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::channels::GatheringByteChannel>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::GatheringByteChannel>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::GatheringByteChannel>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::GatheringByteChannel>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::channels::GatheringByteChannel>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_CHANNELS_GATHERINGBYTECHANNEL_H
