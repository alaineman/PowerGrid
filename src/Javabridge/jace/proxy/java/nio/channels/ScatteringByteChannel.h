...
#define JACE_PROXY_JAVA_NIO_CHANNELS_SCATTERINGBYTECHANNEL_H
...
/**
 * The Jace C++ proxy class for java/nio/channels/ScatteringByteChannel.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class ScatteringByteChannel : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::nio::channels::ReadableByteChannel {
...
ScatteringByteChannel( jvalue value );
ScatteringByteChannel( jobject object );
ScatteringByteChannel( const ScatteringByteChannel& object );
ScatteringByteChannel( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< ScatteringByteChannel> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::channels::ScatteringByteChannel>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::channels::ScatteringByteChannel>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::channels::ScatteringByteChannel>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::ScatteringByteChannel>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::ScatteringByteChannel>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::channels::ScatteringByteChannel>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::channels::ScatteringByteChannel>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_CHANNELS_SCATTERINGBYTECHANNEL_H
