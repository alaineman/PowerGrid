...
#define JACE_PROXY_JAVA_NIO_FILE_COPYOPTION_H
...
/**
 * The Jace C++ proxy class for java/nio/file/CopyOption.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class CopyOption : public virtual ::jace::proxy::java::lang::Object {
 ...
 */
CopyOption();
CopyOption( jvalue value );
CopyOption( jobject object );
CopyOption( const CopyOption& object );
CopyOption( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< CopyOption> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::CopyOption>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::CopyOption>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::CopyOption>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::CopyOption>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::CopyOption>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::CopyOption>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::CopyOption>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_COPYOPTION_H
