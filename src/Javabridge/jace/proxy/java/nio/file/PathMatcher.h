...
#define JACE_PROXY_JAVA_NIO_FILE_PATHMATCHER_H
...
/**
 * The Jace C++ proxy class for java/nio/file/PathMatcher.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class PathMatcher : public virtual ::jace::proxy::java::lang::Object {
 ...
 *
 */
::jace::proxy::types::JBoolean matches( ::jace::proxy::java::nio::file::Path p0 );
 ...
 */
PathMatcher();
PathMatcher( jvalue value );
PathMatcher( jobject object );
PathMatcher( const PathMatcher& object );
PathMatcher( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< PathMatcher> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::PathMatcher>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::PathMatcher>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::PathMatcher>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::PathMatcher>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::PathMatcher>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::PathMatcher>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::PathMatcher>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_PATHMATCHER_H
