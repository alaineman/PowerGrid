...
#define JACE_PROXY_JAVA_NIO_FILE_WATCHEVENT_KIND_H
...
/**
 * The Jace C++ proxy class for java/nio/file/WatchEvent$Kind.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class WatchEvent_Kind : public virtual ::jace::proxy::java::lang::Object {
 ...
 *
 */
::jace::proxy::java::lang::Class type();
 ...
 */
WatchEvent_Kind();
WatchEvent_Kind( jvalue value );
WatchEvent_Kind( jobject object );
WatchEvent_Kind( const WatchEvent_Kind& object );
WatchEvent_Kind( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< WatchEvent_Kind> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::WatchEvent_Kind>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::WatchEvent_Kind>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::WatchEvent_Kind>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::WatchEvent_Kind>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::WatchEvent_Kind>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::WatchEvent_Kind>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::WatchEvent_Kind>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_WATCHEVENT_KIND_H
