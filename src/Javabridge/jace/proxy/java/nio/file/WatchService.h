...
#define JACE_PROXY_JAVA_NIO_FILE_WATCHSERVICE_H
...
/**
 * The Jace C++ proxy class for java/nio/file/WatchService.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class WatchService : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::io::Closeable {
 ...
 *
 */
::jace::proxy::java::nio::file::WatchKey poll();

/**
 * poll
 *
 */
::jace::proxy::java::nio::file::WatchKey poll( ::jace::proxy::types::JLong p0, ::jace::proxy::java::util::concurrent::TimeUnit p1 );

/**
 * take
 *
 */
::jace::proxy::java::nio::file::WatchKey take();
 ...
 */
WatchService();
WatchService( jvalue value );
WatchService( jobject object );
WatchService( const WatchService& object );
WatchService( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< WatchService> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::WatchService>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::WatchService>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::WatchService>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::WatchService>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::WatchService>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::WatchService>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::WatchService>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_WATCHSERVICE_H
