...
#define JACE_PROXY_JAVA_NIO_FILE_WATCHABLE_H
...
/**
 * The Jace C++ proxy class for java/nio/file/Watchable.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Watchable : public virtual ::jace::proxy::java::lang::Object {
 ...
 */
Watchable();
Watchable( jvalue value );
Watchable( jobject object );
Watchable( const Watchable& object );
Watchable( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< Watchable> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::Watchable>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::Watchable>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::Watchable>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::Watchable>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::Watchable>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::Watchable>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::Watchable>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_WATCHABLE_H
