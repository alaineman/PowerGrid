...
#define JACE_PROXY_JAVA_NIO_FILE_ATTRIBUTE_FILEATTRIBUTE_H
...
/**
 * The Jace C++ proxy class for java/nio/file/attribute/FileAttribute.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class FileAttribute : public virtual ::jace::proxy::java::lang::Object {
 ...
 *
 */
::jace::proxy::java::lang::Object value();
 ...
 */
FileAttribute();
FileAttribute( jvalue value );
FileAttribute( jobject object );
FileAttribute( const FileAttribute& object );
FileAttribute( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< FileAttribute> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::attribute::FileAttribute>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::attribute::FileAttribute>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::attribute::FileAttribute>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileAttribute>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileAttribute>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileAttribute>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileAttribute>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_ATTRIBUTE_FILEATTRIBUTE_H
