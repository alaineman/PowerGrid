...
#define JACE_PROXY_JAVA_NIO_FILE_ATTRIBUTE_FILETIME_H
...
/**
 * The Jace C++ proxy class for java/nio/file/attribute/FileTime.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class FileTime : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::lang::Comparable {
 ...
 *
 */
static ::jace::proxy::java::nio::file::attribute::FileTime from( ::jace::proxy::types::JLong p0, ::jace::proxy::java::util::concurrent::TimeUnit p1 );

/**
 * fromMillis
 *
 */
static ::jace::proxy::java::nio::file::attribute::FileTime fromMillis( ::jace::proxy::types::JLong p0 );

/**
 * to
 *
 */
::jace::proxy::types::JLong to( ::jace::proxy::java::util::concurrent::TimeUnit p0 );

/**
 * toMillis
 *
 */
::jace::proxy::types::JLong toMillis();
 ...
 *
 */
::jace::proxy::types::JInt compareTo( ::jace::proxy::java::nio::file::attribute::FileTime p0 );
 ...
 *
 */
FileTime( jvalue value );
FileTime( jobject object );
FileTime( const FileTime& object );
FileTime( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< FileTime> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::attribute::FileTime>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::attribute::FileTime>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::attribute::FileTime>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileTime>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileTime>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileTime>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::attribute::FileTime>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_ATTRIBUTE_FILETIME_H
