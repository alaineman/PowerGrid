...
#define JACE_PROXY_JAVA_NIO_FILE_ATTRIBUTE_GROUPPRINCIPAL_H
...
/**
 * The Jace C++ proxy class for java/nio/file/attribute/GroupPrincipal.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class GroupPrincipal : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::nio::file::attribute::UserPrincipal {
 ...
 */
GroupPrincipal();
GroupPrincipal( jvalue value );
GroupPrincipal( jobject object );
GroupPrincipal( const GroupPrincipal& object );
GroupPrincipal( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< GroupPrincipal> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::nio::file::attribute::GroupPrincipal>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::nio::file::attribute::GroupPrincipal>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::nio::file::attribute::GroupPrincipal>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::GroupPrincipal>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::GroupPrincipal>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::nio::file::attribute::GroupPrincipal>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::nio::file::attribute::GroupPrincipal>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_NIO_FILE_ATTRIBUTE_GROUPPRINCIPAL_H
