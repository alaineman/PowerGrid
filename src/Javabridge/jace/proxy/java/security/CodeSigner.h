...
#define JACE_PROXY_JAVA_SECURITY_CODESIGNER_H
...
/**
 * The Jace C++ proxy class for java/security/CodeSigner.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class CodeSigner : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::io::Serializable {
 ...
 *
 */
CodeSigner( ::jace::proxy::java::security::cert::CertPath p0, ::jace::proxy::java::security::Timestamp p1 );

/**
 * getSignerCertPath
 *
 */
::jace::proxy::java::security::cert::CertPath getSignerCertPath();

/**
 * getTimestamp
 *
 */
::jace::proxy::java::security::Timestamp getTimestamp();
 ...
 *
 */
CodeSigner( jvalue value );
CodeSigner( jobject object );
CodeSigner( const CodeSigner& object );
CodeSigner( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< CodeSigner> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::security::CodeSigner>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::security::CodeSigner>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::security::CodeSigner>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::security::CodeSigner>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::security::CodeSigner>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::security::CodeSigner>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::security::CodeSigner>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_SECURITY_CODESIGNER_H
