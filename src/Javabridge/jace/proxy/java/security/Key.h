...
#define JACE_PROXY_JAVA_SECURITY_KEY_H
...
/**
 * The Jace C++ proxy class for java/security/Key.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Key : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::io::Serializable {
 ...
 *
 */
::jace::proxy::java::lang::String getAlgorithm();
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::security::Key>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::security::Key>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::security::Key>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::security::Key>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::security::Key>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::security::Key>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::security::Key>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_SECURITY_KEY_H
