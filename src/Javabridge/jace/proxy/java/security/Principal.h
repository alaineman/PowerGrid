...
#define JACE_PROXY_JAVA_SECURITY_PRINCIPAL_H
...
/**
 * The Jace C++ proxy class for java/security/Principal.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Principal : public virtual ::jace::proxy::java::lang::Object {
 ...
 */
Principal();
Principal( jvalue value );
Principal( jobject object );
Principal( const Principal& object );
Principal( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< Principal> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::security::Principal>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::security::Principal>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::security::Principal>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::security::Principal>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::security::Principal>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::security::Principal>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::security::Principal>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_SECURITY_PRINCIPAL_H
