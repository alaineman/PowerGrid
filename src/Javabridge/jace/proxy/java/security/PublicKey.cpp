...
/**
 * The Jace C++ proxy class source for java/security/PublicKey.
 * Please do not edit this source, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
#ifndef VIRTUAL_INHERITANCE_IS_BROKEN
  #define PublicKey_INITIALIZER : ::jace::proxy::java::lang::Object( NO_OP )
#else
  #define PublicKey_INITIALIZER
#endif
 ...
 *
 */
::jace::JFieldProxy< ::jace::proxy::types::JLong > PublicKey::serialVersionUID() {
 ...
 *
 */
PublicKey::PublicKey() : Object( NO_OP ) { 
}

PublicKey::PublicKey( jvalue value ) PublicKey_INITIALIZER {
  setJavaJniValue( value );
}

PublicKey::PublicKey( jobject object ) PublicKey_INITIALIZER {
  setJavaJniObject( object );
}

PublicKey::PublicKey( const PublicKey& object ) PublicKey_INITIALIZER {
  setJavaJniObject( object.getJavaJniObject() );
}

PublicKey::PublicKey( const NoOp& noOp ) PublicKey_INITIALIZER {
}

const JClass* PublicKey::staticGetJavaJniClass() throw ( JNIException ) {
  static JClassImpl javaClass( "java/security/PublicKey" );
  return &javaClass;
}

const JClass* PublicKey::getJavaJniClass() const throw ( JNIException ) {
  return PublicKey::staticGetJavaJniClass();
}

JEnlister< PublicKey> PublicKey::enlister;
