...
#define JACE_PROXY_JAVA_SECURITY_CERT_CERTIFICATE_H
...
/**
 * The Jace C++ proxy class for java/security/cert/Certificate.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Certificate : public virtual ::jace::proxy::java::lang::Object, public virtual ::jace::proxy::java::io::Serializable {
 ...
 *
 */
void verify( ::jace::proxy::java::security::PublicKey p0 );

/**
 * verify
 *
 */
void verify( ::jace::proxy::java::security::PublicKey p0, ::jace::proxy::java::lang::String p1 );
 ...
 *
 */
::jace::proxy::java::security::PublicKey getPublicKey();
 ...
 *
 */
Certificate( jvalue value );
Certificate( jobject object );
Certificate( const Certificate& object );
Certificate( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< Certificate> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::security::cert::Certificate>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::security::cert::Certificate>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::security::cert::Certificate>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::security::cert::Certificate>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::security::cert::Certificate>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::security::cert::Certificate>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::security::cert::Certificate>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_SECURITY_CERT_CERTIFICATE_H
