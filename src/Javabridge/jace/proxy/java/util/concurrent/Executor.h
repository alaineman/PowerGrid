...
#define JACE_PROXY_JAVA_UTIL_CONCURRENT_EXECUTOR_H
...
/**
 * The Jace C++ proxy class for java/util/concurrent/Executor.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class Executor : public virtual ::jace::proxy::java::lang::Object {
 ...
 *
 */
void execute( ::jace::proxy::java::lang::Runnable p0 );
 ...
 */
Executor();
Executor( jvalue value );
Executor( jobject object );
Executor( const Executor& object );
Executor( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< Executor> enlister;
};
...
BEGIN_NAMESPACE( jace )
  ...
  template <> ElementProxy< ::jace::proxy::java::util::concurrent::Executor>::ElementProxy( jarray array, jvalue element, int index );
  template <> ElementProxy< ::jace::proxy::java::util::concurrent::Executor>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::util::concurrent::Executor>& proxy );
#else
...
#ifndef PUT_TSDS_IN_HEADER
  template <> JFieldProxy< ::jace::proxy::java::util::concurrent::Executor>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> JFieldProxy< ::jace::proxy::java::util::concurrent::Executor>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> JFieldProxy< ::jace::proxy::java::util::concurrent::Executor>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::util::concurrent::Executor>& object );
#else
...
#endif // #ifndef JACE_PROXY_JAVA_UTIL_CONCURRENT_EXECUTOR_H
